<?php
# _transactions_/incoming-transactions.php
...
<div class="card border-left-primary shadow mb-4">
  <div class="card-header py-3">
    <?php AddContentTitle('Incoming Transactions', true, CreateCustomURL('transactions')); ?>
  </div>
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-striped table-hover table-bordered mb-0" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          <?php
          $query = RetrieveIncomingTransactions($_SESSION['userportal']);
          ...
          <tr>
            ...
            <td>
              ...
              <a class="text-xs btn btn-info d-block my-1" href="<?php echo CreateCustomGetURL('receive-transaction', $transaction['id']); ?>" title="Receive Transaction"><i class="fas fa-hand-holding-medical" aria-hidden="true"></i></a>
            </td>
          </tr>
          <?php endwhile; ?>
        </tbody>
