...
<div class="card border-left-primary shadow mb-4">
  <div class="card-header py-3"><?php
    $backlink = ($url == 'non-user-schools-list') ? CreateCustomURL('school-users') : $_SERVER['HTTP_REFERER'];
      ...
      <table class="table table-striped table-hover table-bordered mb-0" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody><?php
          ...
          <tr>
            ...
            <td class="text-capitalize"><?php echo $row['school']; ?></td>
            <td class="text-capitalize"><?php echo ToAddress($row['lot'], $row['street'], $row['subdivision'], $row['barangay'], $row['city']); ?></td>
